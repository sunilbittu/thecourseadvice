...
import { getCourses } from "@courseadvice/db/queries";
...
export default async function InstituteDetailPage({
  ...
  // Filter out undefined values from socialLinks for type safety
  const cleanedInstitute = {
    ...institute,
    socialLinks: Object.fromEntries(
      Object.entries(institute.socialLinks).filter(([, v]) => v !== undefined)
    ) as Record<string, string>,
  };

  return <InstituteDetailClient institute={cleanedInstitute} availableCourses={availableCourses} />;
}
