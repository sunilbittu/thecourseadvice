...
export default function CategoryClient({
  ...
  return (
    <main className="flex-1 page-enter">
      {/* ─── HEADER ─── */}
      <section className="py-12 px-8 border-b border-outline-variant/10">
        <div className="max-w-[1440px] mx-auto">
          <AnimatedSection>
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                <h1 className="font-heading text-[3rem] font-extrabold leading-[1.05] tracking-[-0.03em] text-on-surface">
                  {category}
                </h1>
      ...
      <section className="py-10 px-8">
        <div className="max-w-[1440px] mx-auto flex gap-8 items-start">

          {/* ── FILTERS SIDEBAR ── */}
          <aside className="w-64 shrink-0 sticky top-24">
            <div className="bg-white rounded-2xl ghost-border p-6 space-y-7">
              {/* Header */}
              ...
              <div>
                ...
                <div className="space-y-2.5">
                  {(["all", "free", "paid"] as const).map((opt) => (
                    <label
                      key={opt}
                      onClick={() => setFilters((prev) => ({ ...prev, price: opt }))}
          ...
          <div className="flex-1 min-w-0">
            {filtered.length > 0 ? (
              ...
              <div className="bg-white rounded-2xl p-16 ghost-border text-center">
      ...
      {/* ─── OTHER CATEGORIES ─── */}
      <section className="py-12 px-8 bg-surface-container-low border-t border-outline-variant/10">
        <div className="max-w-[1440px] mx-auto">
          <AnimatedSection>
